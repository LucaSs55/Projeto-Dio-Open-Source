...
4. Crie/Referêncie uma nova **branch** e nomeie como `feat/community/Lucas-Santos`: `git checkout -b feat/community/"Lucas-Santos"`;
    > Exemplo: `git checkout -b feat/community/Lucas-Santos`
